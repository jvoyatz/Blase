 ...
 * Use the [FavoriteActivitiesFragment.newInstance] factory method to
...
class FavoriteActivitiesFragment : Fragment() {
    ...
    companion object {
         ...
         * @return A new instance of fragment FavoriteActivitesFragment.
         */
        // TODO: Rename and change types and number of parameters
        @JvmStatic
        fun newInstance(param1: String, param2: String) =
            FavoriteActivitiesFragment().apply {
